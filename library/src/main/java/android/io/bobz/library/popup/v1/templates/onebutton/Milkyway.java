...
public class Milkyway<T extends PopupWindow> implements View.OnClickListener {
    ...
    public Milkyway(Context context, Popup popup) {
    ...
    private void setupOptions() {
        ...
        button.setBackgroundDrawable(ButtonDrawable.roundedWithBorder(popup.options.buttons.get(0).backgroundColor, popup.options.buttons.get(0).borderColor));
