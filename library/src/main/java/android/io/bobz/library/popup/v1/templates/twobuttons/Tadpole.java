...
public class Tadpole<T extends PopupWindow> implements View.OnClickListener {
    ...
    public Tadpole(Context context, Popup popup) {
    ...
    protected PopupWindowBuilder createPopupWindowBuilder() {
        ...
        PopupWindowBuilder popupWindowBuilder = new PopupWindowBuilder(context)
                .setContentView(R.layout.popup_tadpole)
    ...
    private void setupOptions() {
        ...
        if (!background.color.isEmpty())
            layout.setBackgroundDrawable(LayoutDrawable.rectangle(background.color));
        ...
        firstButton.setBackgroundDrawable(ButtonDrawable.rectangle(popup.options.buttons.get(0).backgroundColor));
        ...
        secondButton.setBackgroundDrawable(ButtonDrawable.rectangle(popup.options.buttons.get(1).backgroundColor));
