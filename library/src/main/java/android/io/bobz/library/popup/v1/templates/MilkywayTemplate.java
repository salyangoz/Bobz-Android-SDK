package android.io.bobz.library.popup.v1.templates;
...
public class MilkywayTemplate<T extends PopupWindow> implements View.OnClickListener {
    ...
    public MilkywayTemplate(Context context, Popup popup) {
    ...
    protected PopupWindowBuilder createPopupWindowBuilder() {
        ...
        PopupWindowBuilder popupWindowBuilder = new PopupWindowBuilder(context)
                .setContentView(R.layout.layout_milkyway)
    ...
    private void setupOptions() {
        ...
        title.setTextColor(Color.parseColor(popup.options.subtitleColor));

        //Description Textview Options
        description.setText(popup.options.description);
        title.setTextColor(Color.parseColor(popup.options.descriptionColor));
        ...
        if (!background.color.isEmpty())
            layout.setBackgroundColor(Color.parseColor(popup.options.background.color));
        ...
        button.setBackgroundColor(Color.parseColor(popup.options.buttons.get(0).backgroundColor));
        //TODO Button Round Color
